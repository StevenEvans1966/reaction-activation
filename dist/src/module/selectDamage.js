...
function generateEnergyBox(type, defaultValue) {
	//@ts-ignore
	const data = getDamageTypeNameAndIcon(type);
	return `
...
export async function showSelectDamage(damagesToShow, defaultValue, flavor) {
	if (!damagesToShow) {
