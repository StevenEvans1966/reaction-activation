...
function buildSource(keepSources, minifySources = false, output = null) {
  return () => {
    ...
    if (keepSources) stream = stream.pipe(sm.write(".", { includeContent: false }))
...
exports.watch = function () {
  exports.default();
  gulp.watch(SOURCE + GLOB, gulp.series(pdel(DIST + SOURCE), buildSource(false, false)));
...
exports.devWatch = function () {
  ...
  gulp.watch(
    ...
    gulp.series(
      ...
      buildSource(false, false, devDist),
      plog("sources done."),
    ),
  );
  gulp.watch(
